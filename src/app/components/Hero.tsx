                ...
                <div className="text-center text-white">
                    ...
                    <div className="mt-6 bg-white bg-opacity-80 rounded-lg p-4 inline-block">
                        <form className="flex gap-2">
                            <input type="date" className="px-2 py-1 rounded" required/>
                            <input type="date" className="px-2 py-1 rounded" required/>
                            <input type="number" placeholder="People" className="px-2 py-1 rounded w-20" required/>
                            <button type="submit" className="bg-blue-600 text-white px-4 py-1 rounded">搜索</button>
                        </form>
                    </div>
                </div>
            </div>
